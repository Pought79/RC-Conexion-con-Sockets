...
public class PeerMessageOps {
	...
	public static final byte OPCODE_FILEDOWNLOAD_CHUNK = 1;
	 ...
	 */
	private static final Byte[] _valid_opcodes = { OPCODE_INVALID_CODE, OPCODE_FILEDOWNLOAD_CHUNK,
			OPCODE_FILE_NOT_FOUND, OPCODE_FILE_CHUNK

	};
	private static final String[] _valid_operations_str = { "INVALID_OPCODE", "DOWNLOAD_CHUNK", "FILE_NOT_FOUND",
			"FILE_CHUNK"
